...
"""
code is taken from here https://www.kaggle.com/haqishen/augmix-based-on-albumentations
paper from https://arxiv.org/abs/1912.02781

**Notes:
Right now the implementation is buggy so the order or augmentation matters
"""
