...
if __name__ == "__main__":
    ...
    # test file
    original_test_df = pd.read_csv("../input/siim-isic-melanoma-classification/test.csv")
    ...
    test_nvnn_4 = pd.read_csv("../input/stacking/best/nvnn/submission_b0_926_384_aedata.csv")
    ...
    original_train_df = original_train_df.merge(khanh_1, left_on='image_name', right_on="image_name", how="left")
    original_train_df = original_train_df.merge(khanh_2, left_on='image_name', right_on="image_name", how="left")
    original_train_df = original_train_df.merge(nvnn_3, left_on='image_name', right_on="image_name", how="left")
    original_train_df = original_train_df.merge(nvnn_4, left_on='image_name', right_on="image_name", how="left")
    original_train_df = original_train_df.merge(nvnn_5, left_on='image_name', right_on="image_name", how="left")
    original_train_df = original_train_df.merge(nvnn_6, left_on='image_name', right_on="image_name", how="left")
    original_train_df = original_train_df.merge(nvnn_7, left_on='image_name', right_on="image_name", how="left")
    original_train_df = original_train_df.merge(nvnn_8, left_on='image_name', right_on="image_name", how="left")

    original_test_df = original_test_df.merge(test_khanh_1, left_on='image_name', right_on="image_name", how="left")
    original_test_df = original_test_df.merge(test_khanh_2, left_on='image_name', right_on="image_name", how="left")
    original_test_df = original_test_df.merge(test_nvnn_3, left_on='image_name', right_on="image_name", how="left")
    original_test_df = original_test_df.merge(test_nvnn_4, left_on='image_name', right_on="image_name", how="left")
    original_test_df = original_test_df.merge(test_nvnn_5, left_on='image_name', right_on="image_name", how="left")
    original_test_df = original_test_df.merge(test_nvnn_6, left_on='image_name', right_on="image_name", how="left")
    original_test_df = original_test_df.merge(test_nvnn_7, left_on='image_name', right_on="image_name", how="left")
    original_test_df = original_test_df.merge(test_nvnn_8, left_on='image_name', right_on="image_name", how="left")
    ...
    original_test_df = original_test_df.merge(original_test_df_feature, left_on="patient_id", right_on="patient_id", how="left")
    ...
    for fold in range(5):
        ...
        meta_columns = [i for i in df_train.columns if i not in ['image_name', 'patient_id', 
                                                                 ...
                                                                 'target', 'tfrecord', 'width', 'height', 'patient_code', 'kfold', 'oof_preds']]
        ...
        sub_preds += gbm.predict(original_test_df[meta_columns], num_iteration=gbm.best_iteration) / 5
    ...
    submission.to_csv("../output/best/944_stacking.csv", index=False)
